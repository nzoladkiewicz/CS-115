...
class Car(object):
    ...
    def __init__(self, make, model, mpg, tank_capacity):
        '''Constructor for class Car. Takes make, model, mpg, and tank_capacity as
        private attributes.'''
        self.__make = make
        self.__model = model
        self.__mpg = mpg
    ...
    def set_mpg(self, new):
        '''Setter for mpg'''
        self.__mpg = new

    def set_tank_capacity(self, new):
        '''Setter for tank capacity'''
        self.__tank_capacity = new
    ...
    def get_total_range(self):
        '''Calculates and gets total_range'''
...
class HybridCar(Car):  
    ...
    def __init__(self, make, model, mpg, tank_capacity, battery_kWh, miles_per_kWh):
        '''Child class of Car. Takes 6 arguments: the 4 from Car are inherited, and
        battery_kWh and miles_per_kWh are introduced.'''
    ...
    def get_total_range(self):
        '''Overrides the get_total_range method inherited from parent class.'''
