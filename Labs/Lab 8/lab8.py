...
Fibonacci = """
00 read r1      # get user input and store in r1
01 jeqzn r1 19  # if r1 is equal to 0, jump to line 19
02 setn r2 0    # set r2 equal to 0
03 setn r3 1    # set r3 equal to 1
04 write r2     # print r2
05 addn r1 -1   # change r1 = r1 - 1
06 jeqzn r1 19  # if r1 is equal to 0, jump to line 19
07 write r3     # print r3
08 addn r1 -1   # change r 1 = r1 - 1
09 jeqzn r1 19  # if r1 is equal to 0, jump to line 19
10 add r2 r2 r3 # change r2 = r2 + r3
11 write r2     # print r2
12 addn r1 -1   # change r1 = r1 - 1
13 jeqzn r1 19  # if r1 is equal to 0, jump to line 19
14 add r3 r2 r3 # change r3 = r2 + r3
15 write r3     # print r3
16 addn r1 -1   # change r1 = r1 - 1
17 jeqzn r1 19  # if r1 is equal to 0, jump to line 19
18 jumpn 10     # set program counter to 10
19 halt         # stop program
"""
